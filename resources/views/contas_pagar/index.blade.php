    ...
    <main class="fp-main">
        <div class="container-xxl py-4">
            ...
            <div class="fp-page-header d-flex align-items-center justify-content-between mb-4 flex-wrap gap-3">
                <div>
                    <h1 class="fp-page-title mb-1">Contas a Pagar</h1>
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="{{ route('contas-pagar.create') }}" class="btn fp-btn-primary btn-sm d-flex align-items-center gap-1">
            ...
            <div class="row g-3 mb-4">
                    ...
                    <div class="fp-card fp-card-summary h-100">
                        <div class="fp-card-body">
                            <div class="d-flex align-items-start justify-content-between mb-3">
                                <div class="fp-card-icon fp-icon-primary"><i class="bi bi-arrow-left-right"></i>
                                </div>
                                <span class="fp-badge-trend fp-trend-up"><i class="bi bi-arrow-up-short"></i>
                                    6,2%</span>
                            </div>
                ...
                <div class="col-6 col-xl-3">
                    <div class="fp-card fp-card-summary h-100">
                        <div class="fp-card-body">
                            <div class="d-flex align-items-start justify-content-between mb-3">
                                <div class="fp-card-icon fp-icon-success"><i class="bi bi-arrow-down-circle"></i>
                                </div>
                                <span class="fp-badge-trend fp-trend-up"><i class="bi bi-arrow-up-short"></i>
                                    12,1%</span>
                            </div>
                    ...
                    <div class="fp-card fp-card-summary h-100">
                        <div class="fp-card-body">
                            <div class="d-flex align-items-start justify-content-between mb-3">
                                ...
                                <span class="fp-badge-trend fp-trend-down"><i class="bi bi-arrow-down-short"></i>
                                    3,4%</span>
                            </div>
                ...
                <div class="fp-card-body py-3 px-4">
                    <div class="d-flex align-items-center gap-3 flex-wrap">
                        ...
                        <div class="fp-search-wrap">
                            ...
                            <input type="text" class="form-control fp-search" placeholder="Buscar movimentação..."
                                id="searchInput" style="width:220px" />
                        </div>
                        ...
                        <button class="btn fp-btn-outline-secondary btn-sm ms-auto d-flex align-items-center gap-1"
                            id="clearFilters">
            ...
            <div class="fp-card">
                <div class="fp-card-body p-0">
                    ...
                    <!-- Table toolbar -->
                    <div
                        class="d-flex align-items-center justify-content-between px-4 py-3 border-bottom fp-table-toolbar flex-wrap gap-2">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div class="fp-bulk-actions d-none align-items-center gap-2" id="bulkActions">
                                ...
                                <button class="btn fp-btn-outline-secondary btn-sm"><i
                                        class="bi bi-check2-all me-1"></i>Confirmar</button>
                                <button class="btn btn-sm fp-btn-danger-outline"><i
                                        class="bi bi-trash me-1"></i>Excluir</button>
                            </div>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                        ...
                        <table class="table fp-table mb-0" id="movTable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="fp-th-sort" data-col="date">Data <i
                                            class="bi bi-arrow-down-up ms-1 fp-sort-icon"></i></th>
                                    <th class="fp-th-sort" data-col="desc">Descrição <i
                                            class="bi bi-arrow-down-up ms-1 fp-sort-icon"></i></th>
                                    <th class="d-none d-lg-table-cell">Conta / Banco</th>
                                    <th class="d-none d-md-table-cell fp-th-sort" data-col="category">Categoria <i
                                            class="bi bi-arrow-down-up ms-1 fp-sort-icon"></i></th>
                                    <th class="d-none d-sm-table-cell">Tipo</th>
                                    <th class="fp-th-sort" data-col="amount">Valor <i
                                            class="bi bi-arrow-down-up ms-1 fp-sort-icon"></i></th>
                                    <th>Status</th>
                    ...
                    <!-- Pagination -->
                    <div
                        class="d-flex align-items-center justify-content-between px-4 py-3 border-top flex-wrap gap-2">
